...
"AUC" in the title of the right plot stands for area under the curve. AUC tells us the area under the ROC curve, and, generally, an AUC values that is larger is preffered over an AUC value that is lower.
